#include "Arduino.h"
#include "Hstepper.h"
//hardware wiring, in1 to pin 6,in2 to 7, in3 to 8, in4 to 9.
//+pwer connected to 5V, -pwer connected to ground. 
//microcontroller semicircle facing away from orange thingy.
void A (int d){
...
int d = 5;//delay between steps, changes motor speed
